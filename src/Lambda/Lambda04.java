    ...
    */
    ...
    public static int notOrt63BykUnvOgrcSayisiTopla(List<Universite> unv) {
        return unv.
                ...
                map(t -> t.getOgrSayisi()).  // akistaki objeler degisti map ile sayi oldu
                // reduce(Integer::sum);
    ...
    public static int notOrt63BykUnvOgrcSayisiToplaToInt(List<Universite> unv) {
        return unv.
                stream().  // burda objeler var unv isimleri
                filter(t -> t.getNotOrt() > 63). // burda bu unv ler filtrelendi
                mapToInt(t -> t.getOgrSayisi()).  // burda int deger yani sayiya cevrildi map ile boylece  sum gelir
                sum();                                // map= isaretle ,degistir demek
    ...
    public static OptionalDouble ogrcSayisi333BykNotOrtOrtlamaAl(List<Universite> unv) {
        ...
        return unv.
                ...
                mapToDouble(t -> t.getNotOrt()).//  map ile double sayiya donustur, degigtir, isaretle demek
    ...
    public static int mathBolmSayısı(List<Universite> unv) {
        return (int) unv.
                stream().
                filter(t -> t.getBolum().contains("mat")).   // mat bolum olan uvr alindi
