...
public class Lambda03 {
    ...
    public  static void charSayisiBykElPrint(List<String> menü){
        Stream<String> sonIsim=menü.
              ...
              //  findFirst());  // ilk eleman alindi
                limit(3);  // limit(a) akistan cikan elemanlari a parametresine gore ilk a elemani alir
        System.out.println(Arrays.toString(sonIsim.toArray())); //
        // sonIsim.toArray() = limit() meth return dan dolayi stream type olan
        // sonIsim toArray() method ile array type convert edildi.

        // limit(1) => sinirlandirma demektir.
        // Bu akisin elemanlarindan olusan uzunlugu maxSize den uzun olmayacak sekilde kesilmis bir akis return eder.
        // stream return eder. akis ciktisini bir variable assing edebilir
        /*
        trict: stream lar eekrana direk yazdirilamaz . Stream i toArray() ile array e ceviririz. array i de
         Arrays.toString() in icine alip yazdirabiliriz.
         orn: System.out.println(Arrays.toString(stream.toArray())); veya
             System.out.println(Arrays.asList(*****.toArray()));  kulllanilabilir.
         */
    ...
    public static void ilkElHarcSonHrfSiraliPrint(List<String>menü){
        ...
        menü.
                ...
                skip(1).  // ilk eleman atlandi (adana)
                forEach((t-> System.out.print(t+" ")));  // print edildi
        //
        // skip(1) = atlama demek. akisin ilk n elemanini atladiktan sonra geriye kalan elemnlarindan olusan bir akis return eder.
        // bu akis n den daha az oge ise bos bir akis dondurur. bu durum bilgisi olan bir ara islemdir.
        // skip(list.size()-1 = list in uzunlugunun 1 eksigini yazarsak son elemani yazdiririz
